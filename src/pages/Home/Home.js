...
const Home = () => {
    ...
    return (
        <div className='mt-10 mb-10'>
            ...
            {
                user ? <>
                    <div className='bg-[#1874EE] w-full h-96 rounded-xl flex justify-evenly p-10 banner'>
                        <div className='py-24 w-3/4 banner-text'>
                            <p className='text-3xl font-bold text-white mb-3'>Welcome Back, {user?.displayName}</p>
                            <p className='mb-5 text-white pr-60 text-justify text'>Design your own custom daily planner and get organized for free with easy to use online planner maker. Complete your daily tasks. To check your tasks click here.</p>
                            <Link to='/mytask' className='py-2 px-4 shadow-md bg-white rounded-lg text-[#1874EE] font-medium'>My Tasks</Link>
                        </div>
                        <img src={img} alt="" className='w-auto img' />
                    </div></>
                    :
                    <><p className='text-lg text-center my-10 font-bold mb-20'>No Task Added Yet.</p></>
            }
            <div className='grid grid-cols-3 mt-8 h-60 gap-20 grid-boxes mb-5'>
